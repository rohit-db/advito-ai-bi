...
export interface TrendingFillIconProps extends React.SVGProps<SVGSVGElement> {
...
export const TrendingFillIcon = forwardRef<SVGSVGElement, TrendingFillIconProps>(
